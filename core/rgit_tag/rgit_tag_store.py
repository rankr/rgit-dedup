...
def rgit_tag_store(git_repo_path, tag_store_path = '../tag_store/tag'):
	'''
	...
	tagstore = TagStore.TagStore(tag_store_path)
	tagstore.absorb(ret)

def recover(sha, tag_store_path = '../tag_store/tag'):
	b = TagStore.TagStore(tag_store_path)
	return b.cat_tag(sha)